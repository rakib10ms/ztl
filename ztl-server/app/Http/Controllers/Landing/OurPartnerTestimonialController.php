...
use App\Models\ZtlOurPartnerTestimonial;
use Illuminate\Support\Facades\Validator;
use File;
class OurPartnerTestimonialController extends Controller
{
    public function index()
    {
        $testimonial = ZtlOurPartnerTestimonial::orderBy('id','desc')->get();
    ...
    public function store(Request $request)
    {
            ...
            $testimonial = new ZtlOurPartnerTestimonial();
 ...
 return response()->json([
    ...
    {
        $testimonial = ZtlOurPartnerTestimonial::find($id);
...
public function update(Request $request, $id){
  ...
  if ($files = $request->file('client_image')) {
            ...
            $update_testimonial=ZtlOurPartnerTestimonial::find($id);
