...
function AddWebDevelopmentFaqImage() {
    ...
    const submitServiceLogo = (e) => {
        ...
        if (image == '') {
            ...
            axios.post(`/add-web-development-faq-image`, formData).then(res => {
                if (res.data.status == 200) {
                    setTotalCount(res.data.count);
                        ...
                        <div className="col-md-12 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Faq Image
...
export default AddWebDevelopmentFaqImage
