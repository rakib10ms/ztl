...
function AddWebDevelopmentFaq() {
    ...
    const submitfaq = (e) => {
        ...
        if (faq.faq_qtn == '' || faq.faq_ans == '') {
            ...
            axios.post(`/add-web-development-faq`, faq).then(res => {
                        ...
                        <div className="col-md-12 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Web Development Faq
                                        <Link to={'/web-development-faq'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
...
export default AddWebDevelopmentFaq
