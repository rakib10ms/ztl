...
function EditWebDevelopmentFaq() {
    ...
    useEffect(() => {
        axios.get(`/edit-web-development-faq/${id}`).then(res => {
    ...
    const updateFaq = (e) => {
        ...
        if (faq.faq_qtn == '' || faq.faq_ans == '') {
            ...
            axios.put(`/update-web-development-faq/${id}`, faq).then(res => {
                if (res.data.status == 200) {
                        ...
                        <div className="col-md-12 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add faq Web Development
...
export default EditWebDevelopmentFaq
