...
function AddAboutUsMission() {
    ...
    const submitErp = (e) => {
        ...
        formData.append('mission_description', about.mission_description);
        formData.append('image', image);

        if (about.mission_description == '' ||  image == '' ) {
            ...
            if (totalCount >= 1) {
                ...
                axios.post(`/add-about-us-mission`, formData).then(res => {
                    if (res.data.status == 200) {
                        setTotalCount(res.data.count);
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" value={about.mission_description} className="form-control" name="mission_description" onChange={handleInput} ></textarea>
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="history_name" className="col-form-label-sm">Mission Image</label>
...
export default AddAboutUsMission
