...
const navigate=useNavigate();
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-about-us-vission/${id}`).then(res => {
            if (res.data.status == 200) {
                setaboutMission({
                    vission_description: res.data.about.vission_description,
                });
    ...
    const updateErp = (e) => {
        ...
        formData.append('vission_description', aboutMission.vission_description);
        formData.append('image', image);


        if (aboutMission.vission_description == '' || image == '') {
            ...
            axios.post(`/update-about-us-vission/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                    Swal.fire(res.data.message, '', 'success')
                    navigate('/about-us-vission');
                    setaboutMission({
                        vission_description: "",
                    });
                    setImage('');
                        ...
                        <div className="col-md-12 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Edit Vission Description & Image
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" value={aboutMission.vission_description} className="form-control" name="vission_description" onChange={handleInput} ></textarea>
...
export default EditAboutUsVission
