...
function AddAboutUsTitleLogo() {

    const [aboutTittleLogo, setHealthCareTitleLogo] = useState({
        title_name: "",
    });
    ...
    const handleInput = (e) => {
        setHealthCareTitleLogo({
            ...aboutTittleLogo, [e.target.name]: e.target.value
        });
    }
    ...
    const submitErp = (e) => {
        ...
        formData.append('title_name', aboutTittleLogo.title_name);
        formData.append('image', image);

        if (aboutTittleLogo.title_name == '' || image == '') {
            ...
            if (totalCount >= 1) {
                ...
                axios.post(`/add-about-us-title-logo`, formData).then(res => {
                    if (res.data.status == 200) {
                        setTotalCount(res.data.count);
                        ...
                        setHealthCareTitleLogo({ ...aboutTittleLogo, error_list: res.data.errors });
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={aboutTittleLogo.title_name} className="form-control" name="title_name" onChange={handleInput} />
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    {/* <input type="file" value={aboutTittleLogo.client_image} className="form-control" name="client_image" onChange={(e) => { setImage(e.target.files[0]) }} /> */}
...
export default AddAboutUsTitleLogo
