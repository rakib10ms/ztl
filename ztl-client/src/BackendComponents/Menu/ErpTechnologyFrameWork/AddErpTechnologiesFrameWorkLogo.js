...
function AddErpTechnologiesFrameWorkLogo() {
    ...
    const submitHealthCare = (e) => {
        ...
        if ( image == '' ) {
            ...
            axios.post(`/add-erp-technologies-framework-logo`, formData).then(res => {
                        ...
                        <div className="col-md-12 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Erp Technology Logo
...
export default AddErpTechnologiesFrameWorkLogo
