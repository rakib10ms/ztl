...
function EditErpTechnologiesFrameWorkLogo() {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-erp-technologies-framework-logo/${id}`).then(res => {
    ...
    const updatehealth = (e) => {
        ...
        if (image == '') {
            ...
            axios.post(`/update-erp-technologies-framework-logo/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                    Swal.fire(res.data.message, '', 'success')
                    navigate('/erp-technologies-framework-logo');
                ...
                //     sethealth({ ...health, error_list: res.data.errors });
                            ...
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Edit Erp Technologies
                                        <Link to={'/erp-technologies-framework-logo'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    {/* <input type="file" value={health.client_image} className="form-control" name="client_image" onChange={(e) => { setImage(e.target.files[0]) }} /> */}
...
export default EditErpTechnologiesFrameWorkLogo
