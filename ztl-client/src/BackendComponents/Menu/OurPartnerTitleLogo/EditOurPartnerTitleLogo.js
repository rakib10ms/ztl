...
function EditOurPartnerTitleLogo() {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-our-partner-title-logo/${id}`).then(res => {
    ...
    const updateWeb = (e) => {
        ...
        if (partnerTitleLogo.title_name == '' || image == '') {
            ...
            axios.post(`/update-our-partner-title-logo/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                            ...
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Edit title & banner
                                        <Link to={'/our-partner-title-logo'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
...
export default EditOurPartnerTitleLogo
