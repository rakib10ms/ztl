...
import '../../../imageUrl';
function EditHealthCareTitleLogo() {
    ...
    const handleInput = (e) => {
        setHealthCare({
            ...healthCare, [e.target.name]: e.target.value
        });
    }
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-health-care-title-logo/${id}`).then(res => {
            if (res.data.status == 200) {
                setHealthCare({
                    title_name: res.data.health.title_name,
                });
    ...
    const updateHealth = (e) => {
        ...
        formData.append('title_name', healthCare.title_name);
        formData.append('image', image);


        if (healthCare.title_name == '' || image == '') {
            ...
            axios.post(`/update-health-care-title-logo/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                    ...
                    setHealthCare({ ...healthCare, error_list: res.data.errors });
                            ...
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Edit title & banner
                                        <Link to={'/health-care-title-logo'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                <div className="card-body">
                                    <form id="EarCanalForm" onSubmit={updateHealth} encType="multipart/form-data">
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={healthCare.title_name} className="form-control" name="title_name" onChange={handleInput} />
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    {/* <input type="file" value={healthCare.client_image} className="form-control" name="client_image" onChange={(e) => { setImage(e.target.files[0]) }} /> */}
...
export default EditHealthCareTitleLogo
