    ...
    const submiterpSolution = (e) => {
        ...
        if (erpSolution.title == '' || erpSolution.short_description == ''  || image == '') {
            ...
            Swal.fire("Image size must be less than 0.5 mb", '', 'error')
                ...
                axios.post(`/add-custom-erp-solution`, formData).then(res => {
                        ...
                        <div className="col-md-12 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Custom Erp Solution
                                        <Link to={'/custom-erp-solution'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                <div className="card-body">
                                    <form id="EarCanalForm" onSubmit={submiterpSolution} >
                                        <div className="card-body">
...
export default AddCustomErpSolution
