...
function AddRDWorkItem() {
    ...
    //             setAllRD(res.data.jobList);
    //         }
    //     })

    // }, [])

    // console.log('eo', allRD)
    ...
    const submitRDription = (e) => {
        ...
        formData.append('rd_title', RD.rd_title);
        formData.append('project_name', RD.project_name);
        formData.append('rd_description', content1);
        formData.append('image', image);

        console.log('check all data', formData);

        if (RD.rd_title == '' || RD.project_name == '' || content1 == '' || image == '') {
            ...
            axios.post(`/add-our-rd-work`, formData).then(res => {
                if (res.data.status == 200) {
        ...
        rd_description:"",
                    ...
                    setRD({ ...RD, error_list: res.data.errors });
                        ...
                        <div className="col-md-12 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Our R&D Items
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={RD.project_name} className="form-control" name="project_name" onChange={handleInput} />
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={RD.rd_title} className="form-control" name="rd_title" onChange={handleInput} />
                                                    {/* <span className="text-danger">{heading.error_list.rd_title}</span> */}
