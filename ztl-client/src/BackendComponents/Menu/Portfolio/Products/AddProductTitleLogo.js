...
function AddProductTitleLogo() {
    ...
    const submitHealthCare = (e) => {
        ...
        formData.append('title_name', product.title_name);
        formData.append('image', image);

        if (product.title_name == '' || image == '' ) {
            ...
            axios.post(`/add-product-title-logo`, formData).then(res => {
                if (res.data.status == 200) {
                    setTotalCount(res.data.count)
                    ...
                    setproduct({ ...product, error_list: res.data.errors });
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={product.title_name} className="form-control" name="title_name" onChange={handleInput} />
...
export default AddProductTitleLogo
