...
function EditRdWorkTitleLogo() {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-r-d-work-title-logo/${id}`).then(res => {
            if (res.data.status == 200) {
                setRd({
                    title_name: res.data.rd.title_name,
                });
    ...
    const updateWeb = (e) => {
        ...
        formData.append('title_name', Rd.title_name);
        formData.append('image', image);


        if (Rd.title_name == '' || image == '') {
            ...
            axios.post(`/update-r-d-work-title-logo/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={Rd.title_name} className="form-control" name="title_name" onChange={handleInput} />
...
export default EditRdWorkTitleLogo
