...
function EditCaseStudiesTitleLogo() {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-case-studies-title-logo/${id}`).then(res => {
            if (res.data.status == 200) {
                setcaseStudies({
                    title_name: res.data.case.title_name,
                });
    ...
    const updateWeb = (e) => {
        ...
        formData.append('title_name', caseStudies.title_name);
        formData.append('image', image);


        if (caseStudies.title_name == '' || image == '') {
            ...
            axios.post(`/update-case-studies-title-logo/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                            ...
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Edit title & banner
                                        <Link to={'/case-studies-title-logo'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={caseStudies.title_name} className="form-control" name="title_name" onChange={handleInput} />
...
export default EditCaseStudiesTitleLogo
