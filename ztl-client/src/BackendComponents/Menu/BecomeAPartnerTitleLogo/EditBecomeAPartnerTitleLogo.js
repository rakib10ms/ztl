...
function EditBecomeAPartnerTitleLogo() {

    const [partnerTitleLogo, setPartnerTitleLogo] = useState({
        title_name: "",
    });
    ...
    const handleInput = (e) => {
        setPartnerTitleLogo({
            ...partnerTitleLogo, [e.target.name]: e.target.value
        });
    }
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-become-a-partner-title-logo/${id}`).then(res => {
            if (res.data.status == 200) {
                setPartnerTitleLogo({
                    title_name: res.data.partner.title_name,
                });
    ...
    const updateWeb = (e) => {
        ...
        formData.append('title_name', partnerTitleLogo.title_name);
        formData.append('image', image);


        if (partnerTitleLogo.title_name == '' || image == '') {
            ...
            axios.post(`/update-become-a-partner-title-logo/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                    ...
                    setPartnerTitleLogo({ ...partnerTitleLogo, error_list: res.data.errors });
                            ...
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Edit title & banner
                                        <Link to={'/become-a-partner-title-logo'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={partnerTitleLogo.title_name} className="form-control" name="title_name" onChange={handleInput} />
...
export default EditBecomeAPartnerTitleLogo
