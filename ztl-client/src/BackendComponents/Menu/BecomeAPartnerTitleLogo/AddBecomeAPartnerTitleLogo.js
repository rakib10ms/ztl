...
function AddBecomeAPartnerTitleLogo() {
    ...
    const submitHealthCare = (e) => {
        ...
        formData.append('title_name', partner.title_name);
        formData.append('image', image);

        if (partner.title_name == '' || image == '' ) {
            ...
            axios.post(`/add-become-a-partner-title-logo`, formData).then(res => {
                if (res.data.status == 200) {
                    setTotalCount(res.data.count)
                    ...
                    setpartner({ ...partner, error_list: res.data.errors });
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={partner.title_name} className="form-control" name="title_name" onChange={handleInput} />
...
export default AddBecomeAPartnerTitleLogo
