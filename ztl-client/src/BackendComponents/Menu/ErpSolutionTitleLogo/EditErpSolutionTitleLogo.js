...
function EditErpSolutionTitleLogo() {
...
const navigate=useNavigate();
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-erp-solution-title-logo/${id}`).then(res => {
            if (res.data.status == 200) {
                seterpSolution({
                    title_name: res.data.erp.title_name,
                });
    ...
    const updateErp = (e) => {
        ...
        formData.append('title_name', erpSolution.title_name);
        formData.append('image', image);


        if (erpSolution.title_name == '' || image == '') {
            ...
            axios.post(`/update-erp-solution-title-logo/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                    Swal.fire(res.data.message, '', 'success')
                    navigate('/erp-solution-title-logo');
                    seterpSolution({
                        title_name: "",
                    });
                    setImage('');
                            ...
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Edit title & banner
                                        <Link to={'/erp-solution-title-logo'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={erpSolution.title_name} className="form-control" name="title_name" onChange={handleInput} />
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    {/* <input type="file" value={erpSolution.client_image} className="form-control" name="client_image" onChange={(e) => { setImage(e.target.files[0]) }} /> */}
                                                ...
                                                </div>
                                                {
                                                    picture == '' ? <div className="form-group" style={{ width: '100px', height: '90px' }}>
                                                        <img className="playerProfilePic_home_tile" src={`${global.img_url}/images/erp/${image}`} style={{ width: '100px', height: '90px' }}></img>
                                                    </div>
                                                        :
...
export default EditErpSolutionTitleLogo
