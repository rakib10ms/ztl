...
function AddErpSolutionTitleLogo() {

    const [erpTittleLogo, setHealthCareTitleLogo] = useState({
        title_name: "",
    });
    ...
    const handleInput = (e) => {
        setHealthCareTitleLogo({
            ...erpTittleLogo, [e.target.name]: e.target.value
        });
    }
    ...
    const submitErp = (e) => {
        ...
        formData.append('title_name', erpTittleLogo.title_name);
        formData.append('image', image);

        if (erpTittleLogo.title_name == '' || image == '') {
            ...
            if (totalCount >= 1) {
                ...
                axios.post(`/add-erp-solution-title-logo`, formData).then(res => {
                    if (res.data.status == 200) {
                        setTotalCount(res.data.count);
                        ...
                        setHealthCareTitleLogo({ ...erpTittleLogo, error_list: res.data.errors });
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={erpTittleLogo.title_name} className="form-control" name="title_name" onChange={handleInput} />
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    {/* <input type="file" value={erpTittleLogo.client_image} className="form-control" name="client_image" onChange={(e) => { setImage(e.target.files[0]) }} /> */}
...
export default AddErpSolutionTitleLogo
