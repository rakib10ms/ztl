...
function AddWebTechnologiesFrameWorkLogo() {
    ...
    const submitHealthCare = (e) => {
        ...
        if ( image == '' ) {
            ...
            axios.post(`/add-web-technologies-framework-logo`, formData).then(res => {
                        ...
                        <div className="col-md-12 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Web Technology Logo
                                        <Link to={'/web-technologies-framework-logo'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
...
export default AddWebTechnologiesFrameWorkLogo
