...
function EditWebTechnologiesFrameWorkLogo() {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-web-development-title-logo/${id}`).then(res => {
            if (res.data.status == 200) {
                setWeb({
                    title_name: res.data.webdev.title_name,
                });
                setImage(res.data.webdev.image);
            }
        })
    ...
    const updateWeb = (e) => {
        ...
        formData.append('title_name', web.title_name);
        formData.append('image', image);


        if (web.title_name == '' || image == '') {
            ...
            axios.post(`/update-web-development-title-logo/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                            ...
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Edit title & banner
                                        <Link to={'/web-development-title-logo'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={web.title_name} className="form-control" name="title_name" onChange={handleInput} />
                                                ...
                                                </div>
                                                {
                                                    picture == '' ? <div className="form-group" style={{ width: '100px', height: '90px' }}>
                                                        <img className="playerProfilePic_home_tile" src={`http://localhost:8000/images/webdevcare/${image}`} style={{ width: '100px', height: '90px' }}></img>
                                                    </div>
                                                        :
...
export default EditWebTechnologiesFrameWorkLogo
