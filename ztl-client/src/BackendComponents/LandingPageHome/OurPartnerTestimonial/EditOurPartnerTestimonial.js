...
import '../../../imageUrl';
function EditOurPartnerTestimonial() {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`/edit-our-partner-testimonial/${id}`).then(res => {
    ...
    const updateTestimonial = (e) => {
        ...
        if (testimonial.client_company_name == '' || testimonial.client_designation == '' || testimonial.client_name == '' || testimonial.heading_name == '' || testimonial.heading_description == '') {
            ...
            axios.post(`/update-our-partner-testimonial/${id}`, formData).then(res => {
                if (res.data.status == 200) {
                    ...
                    navigate('/our-partner-testimonial');
                            ...
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Edit Testimonial
                                        <Link to={'/our-partner-testimonial'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                    </h6>
                                </div>
...
export default EditOurPartnerTestimonial
