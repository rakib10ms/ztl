...
function OurPartnerTestimonail() {
    ...
    const deleteTestimonial = (e, id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete(`/delete-our-partner-testimonial/${id}`).then(res => {
                    if (res.data.status === 200) {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (row) => <div>
                <img className="" src={`${global.img_url}/landing/testimonial/${row.client_image}` } width="55px" height="35px" alt="No Image" />
            </div>,
        ...
        {
            title: "Action", field: "patient", render: (row) => <div className='d-flex'><Link to={`/edit-our-partner-testimonial/${row.id}`} class="btn btn-info btn-sm action-btn"><i class="fas fa-edit"></i></Link>
                            ...
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title">Testimonials
                                        <Link to='/add-our-partner-testimonial' className="btn btn-primary btn-sm float-end"> Add Testimonial</Link>
                                    </h6>
                                </div>
...
export default OurPartnerTestimonail;
