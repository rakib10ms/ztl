...
function AddTechnologyIndexLogo() {
    ...
    const submitjobList = (e) => {
        ...
        if (image== '') {
            ...
            if(totalCount >=6){
                Swal.fire("You can't add Six more", '', 'warning')

            }

            else{
                axios.post(`/add-technology-index-logo`, formData).then(res => {
                    if (res.data.status == 200) {
                        setTotalCount(res.data.count)
                        ...
                        <div className="col-md-12 mt-3">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="card-title"> Add Technology Index Logo
...
export default AddTechnologyIndexLogo
