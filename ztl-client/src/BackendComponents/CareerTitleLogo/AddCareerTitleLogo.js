...
function AddCareerTitleLogo() {

    const [CareerTittleLogo, setHealthCareTitleLogo] = useState({
        title_name: "",
    });
    ...
    const handleInput = (e) => {
        setHealthCareTitleLogo({
            ...CareerTittleLogo, [e.target.name]: e.target.value
        });
    }
    ...
    const submitHealthCare = (e) => {
        ...
        formData.append('title_name', CareerTittleLogo.title_name);
        formData.append('image', image);

        if (CareerTittleLogo.title_name == '' || image == '') {
            ...
            if (totalCount >= 1) {
                ...
                axios.post(`/add-career-title-logo`, formData).then(res => {
                    if (res.data.status == 200) {
                        setTotalCount(res.data.count);
                        ...
                        setHealthCareTitleLogo({ ...CareerTittleLogo, error_list: res.data.errors });
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={CareerTittleLogo.title_name} className="form-control" name="title_name" onChange={handleInput} />
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    {/* <input type="file" value={CareerTittleLogo.client_image} className="form-control" name="client_image" onChange={(e) => { setImage(e.target.files[0]) }} /> */}
...
export default AddCareerTitleLogo
