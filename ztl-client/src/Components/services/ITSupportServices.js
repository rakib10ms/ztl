                ...
                <div className="row g-3 mb-2">
                    <div className="col-md-6">
                        <div className="mobile__platform">
                            <h1 className="header-web-development"><span className="header-soft">IT Support </span>Services</h1>
                        </div>
                ...
                <div className="row pt-3 mb-4">
                    <div className="col-12">
                        <div className="web__carousel">
                            <Slider {...ITTechFrameworksSlider}>
                                {
                                    itTechFrameworks.length > 0 && itTechFrameworks.map((item, id) => {
                                        return (
