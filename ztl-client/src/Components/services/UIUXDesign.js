...
const UIUXDesign = () => {
    const UXUITechnologiesFrameworksSlider = {
    ...
    const [uxuiTechFrameworks, setUxuiTechFrameworks] = useState([
    ...
    const [ourRecentUXUIProjects, setOurRecentUXUIProjects] = useState([
    ...
    const [ourRecentUXUIUse, setOurRecentUXUIUse] = useState([
    ...
    console.log("ourRecentUXUIUse", ourRecentUXUIUse)
    return (
        <>
                ...
                <div className="row g-3 mb-2">
                    <div className="col-md-6">
                        <div className="mobile__platform">
                            <h1 className="header-web-development"><span className="header-soft">UX / UI</span> Design</h1>
                        </div>
                ...
                <div className="row pt-3 mb-4">
                    <div className="col-12">
                        <div className="web__carousel">
                            <Slider {...UXUITechnologiesFrameworksSlider}>
                                {
                                    uxuiTechFrameworks.length > 0 && uxuiTechFrameworks.map((item, id) => {
                                        return (
                ...
                <div className="row g-3 pt-5">
                    <div className="col-12">
                        ...
                        <div className="row g-3 pt-2">
                            {
                                ourRecentUXUIProjects.length > 0 && ourRecentUXUIProjects.map((item, id) => {
                                    return (
                                        <>
                                                        ...
                                                        <div className="card">
                                                            <div className="card-body">
                                                                ...
                                                                <div className="card__web__projects__text__list">
                                                                    {
                                                                        ourRecentUXUIUse.length > 0 && ourRecentUXUIUse.map((item, id) => {
                                                                            return (
